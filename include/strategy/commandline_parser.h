...
parse_commandline(int argc, char **argv) {
  ...
  while (true) {
    ...
    case 0:
      ...
      if (strcmp(long_options[option_index].name, "multicast_group_2") == 0) {
        multicast_group_2 = optarg;
      }
      if (strcmp(long_options[option_index].name, "exchange_connection_1") ==
          0) {
        exchange_connection_1 = optarg;
      }
      if (strcmp(long_options[option_index].name, "exchange_connection_2") ==
          0) {
